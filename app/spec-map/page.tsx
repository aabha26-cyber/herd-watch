...
export default function SpecMapPage() {
  ...
  return (
    <div className="relative flex h-screen w-full flex-col bg-surface-900">
      <header className="border-b border-white/10 bg-surface-800/95 px-4 py-2 backdrop-blur">
      ...
      <div className="relative flex flex-1 overflow-hidden">
        <div className="flex-1" style={{ minHeight: "60vh" }}>
          ...
          />
          {/* Invisible click overlay: we need to pass click to map. For simplicity we use a button to "Add point at center" or we add click handler via a wrapper. Leaflet MapContainer doesn't expose click easily without a child component. So: use "Add point at center" button that adds at map center, or add a MapClickHandler component. */}
        </div>

        <aside className="flex w-80 flex-col gap-3 overflow-y-auto border-l border-white/10 bg-surface-800/95 p-4">
